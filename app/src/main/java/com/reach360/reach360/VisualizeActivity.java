...
public class VisualizeActivity extends AppCompatActivity implements BaseSliderView.OnSliderClickListener,View.OnClickListener , ViewPagerEx.OnPageChangeListener{
   ...
   // HashMap<String,String> Hash_file_maps ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Hash_file_maps = new HashMap<String, String>();
        ...
        for(String name : Hash_file_maps.keySet()){
            ...
            TextSliderView textSliderView = new TextSliderView(VisualizeActivity.this);
            textSliderView
                    .description(name)
        ...
        file_maps.put("Crime against Women 2014",R.drawable.crime_against_women_2014);
        file_maps.put("Category Wise Crime Rate Analysis in 2014 ",R.drawable.category_wise_crime);
        file_maps.put("Increase in Crime Rate in India in Various Years",R.drawable.inc_crime);
        file_maps.put("State Wise Crime Analysis", R.drawable.state_crime);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.begin:
                startActivity(new Intent(VisualizeActivity.this,optionsActivity.class));
                break;
