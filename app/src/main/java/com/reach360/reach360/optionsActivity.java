...
import com.reach360.reach360.tryheatmaps.MainHeatActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* hover.findViewById(R.id.heart).setOnClickListener(new View.OnClickListener() {
        ...
        hover.findViewById(R.id.share).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                YoYo.with(Techniques.Swing)
                        .duration(550)
                        .playOn(v);
                startActivity(new Intent(getApplicationContext(), MainHeatActivity.class));
            }
        });
        ...
        hover3.findViewById(R.id.eye).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), VisualizeActivity.class));
            }
        });
