...
import com.reach360.reach360.tryheatmaps.heatmaps.Gradient;
import com.reach360.reach360.tryheatmaps.heatmaps.HeatmapTileProvider;
...
public class HeatmapsDemoActivity extends BaseDemoActivity {
    ...
    private LatLngBounds INDIA = new LatLngBounds(new LatLng(23.63936, 68.14712), new LatLng(28.20453, 97.34466));
    ...
    protected void startDemo() {
        ...
        getMap().moveCamera(CameraUpdateFactory.newLatLngZoom(INDIA.getCenter(),4));
        ...
        try {
            mLists.put(getString(R.string.result), new DataSet(readItems(R.raw.result)));
        ...
        public void onItemSelected(AdapterView<?> parent, View view,
            ...
            if (mProvider == null) {
                mProvider = new HeatmapTileProvider.Builder().data(
                        mLists.get(getString(R.string.result)).getData()).build();
