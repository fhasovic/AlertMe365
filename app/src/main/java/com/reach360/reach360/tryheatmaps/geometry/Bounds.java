package com.reach360.reach360.tryheatmaps.geometry;
...
public class Bounds {
    ...
    public boolean intersects(com.reach360.reach360.tryheatmaps.geometry.Bounds bounds) {
        return intersects(bounds.minX, bounds.maxX, bounds.minY, bounds.maxY);
    }

    public boolean contains(com.reach360.reach360.tryheatmaps.geometry.Bounds bounds) {
