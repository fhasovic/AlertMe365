package com.reach360.reach360.tryheatmaps.quadtree;

import com.reach360.reach360.tryheatmaps.geometry.Bounds;
import com.reach360.reach360.tryheatmaps.geometry.Point;
 ...
 */
public class PointQuadTree<T extends com.reach360.reach360.tryheatmaps.quadtree.PointQuadTree.Item> {
     ...
     * Child quads.
     */
    private List<com.reach360.reach360.tryheatmaps.quadtree.PointQuadTree<T>> mChildren = null;
     ...
     */
    private void split() {
        mChildren = new ArrayList<com.reach360.reach360.tryheatmaps.quadtree.PointQuadTree<T>>(4);
        mChildren.add(new com.reach360.reach360.tryheatmaps.quadtree.PointQuadTree<T>(mBounds.minX, mBounds.midX, mBounds.minY, mBounds.midY, mDepth + 1));
        mChildren.add(new  com.reach360.reach360.tryheatmaps.quadtree.PointQuadTree<T>(mBounds.midX, mBounds.maxX, mBounds.minY, mBounds.midY, mDepth + 1));
        mChildren.add(new  com.reach360.reach360.tryheatmaps.quadtree.PointQuadTree<T>(mBounds.minX, mBounds.midX, mBounds.midY, mBounds.maxY, mDepth + 1));
        mChildren.add(new com.reach360.reach360.tryheatmaps.quadtree.PointQuadTree<T>(mBounds.midX, mBounds.maxX, mBounds.midY, mBounds.maxY, mDepth + 1));
    ...
    private void search(Bounds searchBounds, Collection<T> results) {
        ...
        if (this.mChildren != null) {
            for (com.reach360.reach360.tryheatmaps.quadtree.PointQuadTree<T> quad : mChildren) {
